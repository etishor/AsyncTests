...
{
    static class ThreadPoolQueueWorkItemExample
    {
        /// <summary>
        /// Use ThreadPool.QueueUserWorkItem() to enqueue @total ( 1 million ) number of actions.
        ...
        public static void Run(int total)
        {
            ...
            using (ManualResetEvent evt = new ManualResetEvent(false))
            {
                ...
                var tasks = Enumerable.Range(0, total)
                    .Select(i => ThreadPool.QueueUserWorkItem((_) =>
                    {
